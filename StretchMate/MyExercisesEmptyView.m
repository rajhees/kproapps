...
@implementation MyExercisesEmptyView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"my-exercises-empty-star-icon-ios7"]];
        [self addSubview:_imageView];
        
        // Determine correct text based on type of error message
        NSString * emptyText = @"No starred exercises";
        NSString * emptySubtitle = @"Tap the star icon on exercises you would like to refer back to later, and they will appear here.";
